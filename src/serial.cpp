...
void Serial::setReadTimeout(uint32_t timeout_ms)
{
    return pimpl_->setReadTimeout(timeout_ms);
}
void Serial::setWriteTimeout(uint32_t timeout_ms)
{
    return pimpl_->setWriteTimeout(timeout_ms);
}
