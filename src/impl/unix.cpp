...
void Serial::SerialImpl::setReadTimeout(uint32_t timeout_ms)
{
    ...
    to.write_timeout_constant   = timeout_.write_timeout_constant;
    to.write_timeout_multiplier = timeout_.write_timeout_multiplier;
	setTimeout(to); 
}
void Serial::SerialImpl::setWriteTimeout(uint32_t timeout_ms)
{
    serial::Timeout to = serial::Timeout::simpleTimeout(timeout_ms);
    to.read_timeout_constant   = timeout_.read_timeout_constant;
    to.read_timeout_multiplier = timeout_.read_timeout_multiplier;
    setTimeout(to);
}
void
